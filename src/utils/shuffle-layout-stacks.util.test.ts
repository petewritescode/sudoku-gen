...
describe('shuffleLayoutStacks', () => {
  test('randomly orders the layout stacks', () => {
    ...
    seedRandom('lorem');
    expect(shuffleLayoutStacks(layout)).toEqual(expected1);

    seedRandom('ipsum');
    expect(shuffleLayoutStacks(layout)).toEqual(expected2);

    seedRandom('amet');
    expect(shuffleLayoutStacks(layout)).toEqual(expected3);
  });
});
