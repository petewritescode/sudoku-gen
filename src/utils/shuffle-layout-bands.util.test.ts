...
describe('shuffleLayoutBands', () => {
  test('randomly orders the layout bands', () => {
    ...
    seedRandom('lorem');
    expect(shuffleLayoutBands(layout)).toEqual(expected1);

    seedRandom('ipsum');
    expect(shuffleLayoutBands(layout)).toEqual(expected2);

    seedRandom('amet');
    expect(shuffleLayoutBands(layout)).toEqual(expected3);
  });
});
